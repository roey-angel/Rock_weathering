...
opts_chunk$set(
  ...
  #  fig.width = 12,
  #  fig.height = 8,
  cache.path = "Arid_rock_weathering_cache/",
  fig.path = "Arid_rock_weathering_figures/"
)
...
Metadata <- read.csv("Data/Arid_rock_weathering_metadata_RA.csv", row.names = 1, header = TRUE)
